...
Main.__name__ = "Main";
Main.main = function() {
	urals_web_BrowserHtmlInjectorTest.run();
	urals_web_BrowserRendererTest.run();
	console.log("test/Main.hx:11:","All tests had been finished");
};
Math.__name__ = "Math";
var Std = function() { };
Std.__name__ = "Std";
...
var sneaker_string_$buffer_interfaces_StringBuffer = function() { };
sneaker_string_$buffer_interfaces_StringBuffer.__name__ = "sneaker.string_buffer.interfaces.StringBuffer";
sneaker_string_$buffer_interfaces_StringBuffer.__isInterface__ = true;
sneaker_string_$buffer_interfaces_StringBuffer.prototype = {
	__class__: sneaker_string_$buffer_interfaces_StringBuffer
};
...
sneaker_string_$buffer_CensoredStringBuffer.__interfaces__ = [sneaker_string_$buffer_interfaces_StringBuffer];
...
sneaker_string_$buffer_StringBuffer.__interfaces__ = [sneaker_string_$buffer_interfaces_StringBuffer];
...
urals_web_AbstractRenderer.__name__ = "urals.web.AbstractRenderer";
...
urals_web_AbstractRenderer.prototype = {
	__class__: urals_web_AbstractRenderer
};
var urals_web_HtmlInjectorInterface = function() { };
urals_web_HtmlInjectorInterface.__name__ = "urals.web.HtmlInjectorInterface";
...
urals_web_BrowserHtmlInjector.__name__ = "urals.web.BrowserHtmlInjector";
...
var urals_web_BrowserHtmlInjectorTest = function() { };
urals_web_BrowserHtmlInjectorTest.__name__ = "urals.web.BrowserHtmlInjectorTest";
urals_web_BrowserHtmlInjectorTest.setBodyNominal = function() {
	window.document.body.outerHTML = "<body>" + "<h1>Header</h1>" + "<div id=\"container\">" + "<div class=\"elem\">Text 1</div>" + "<div class=\"elem\">Text 2</div>" + "</div>" + "</body>";
};
urals_web_BrowserHtmlInjectorTest.testAppend1 = function() {
	urals_web_BrowserHtmlInjectorTest.setBodyNominal();
	var injector = new urals_web_BrowserHtmlInjector();
	var result = injector.append(".elem","<h2>Preheader</h2>");
	var nominal = "<body>" + "<h1>Header</h1>" + "<div id=\"container\">" + "<div class=\"elem\">Text 1<h2>Preheader</h2></div>" + "<div class=\"elem\">Text 2<h2>Preheader</h2></div>" + "</div>" + "</body>";
...
urals_web_BrowserHtmlInjectorTest.testAppend2 = function() {
	...
	var __sneakerTag = null;
	if(window.document.body.outerHTML == nominal != true) {
		var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("Browser",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("Browser.document",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("Browser.document.body",__sneakerPartialEvaluationResult2),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML",__sneakerPartialEvaluationResult3),new sneaker_assertion_EvaluationResult("nominal",__sneakerPartialEvaluationResult4),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML == nominal",__sneakerPartialEvaluationResult5)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserHtmlInjectorTest.hx", lineNumber : 46, className : "urals.web.BrowserHtmlInjectorTest", methodName : "testAppend2"});
		throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
	}
};
urals_web_BrowserHtmlInjectorTest.testPrepend1 = function() {
	urals_web_BrowserHtmlInjectorTest.setBodyNominal();
	var injector = new urals_web_BrowserHtmlInjector();
	...
	var __sneakerTag = null;
	if(window.document.body.outerHTML == nominal != true) {
		var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("Browser",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("Browser.document",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("Browser.document.body",__sneakerPartialEvaluationResult2),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML",__sneakerPartialEvaluationResult3),new sneaker_assertion_EvaluationResult("nominal",__sneakerPartialEvaluationResult4),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML == nominal",__sneakerPartialEvaluationResult5)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserHtmlInjectorTest.hx", lineNumber : 61, className : "urals.web.BrowserHtmlInjectorTest", methodName : "testPrepend1"});
		throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
	}
};
urals_web_BrowserHtmlInjectorTest.testPrepend2 = function() {
	urals_web_BrowserHtmlInjectorTest.setBodyNominal();
	var injector = new urals_web_BrowserHtmlInjector();
	...
	var __sneakerTag = null;
	if(window.document.body.outerHTML == nominal != true) {
		var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("Browser",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("Browser.document",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("Browser.document.body",__sneakerPartialEvaluationResult2),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML",__sneakerPartialEvaluationResult3),new sneaker_assertion_EvaluationResult("nominal",__sneakerPartialEvaluationResult4),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML == nominal",__sneakerPartialEvaluationResult5)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserHtmlInjectorTest.hx", lineNumber : 76, className : "urals.web.BrowserHtmlInjectorTest", methodName : "testPrepend2"});
		throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
	}
};
urals_web_BrowserHtmlInjectorTest.testInner1 = function() {
	urals_web_BrowserHtmlInjectorTest.setBodyNominal();
	var injector = new urals_web_BrowserHtmlInjector();
	...
	var __sneakerTag = null;
	if(window.document.body.outerHTML == nominal != true) {
		var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("Browser",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("Browser.document",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("Browser.document.body",__sneakerPartialEvaluationResult2),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML",__sneakerPartialEvaluationResult3),new sneaker_assertion_EvaluationResult("nominal",__sneakerPartialEvaluationResult4),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML == nominal",__sneakerPartialEvaluationResult5)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserHtmlInjectorTest.hx", lineNumber : 91, className : "urals.web.BrowserHtmlInjectorTest", methodName : "testInner1"});
		throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
	}
};
urals_web_BrowserHtmlInjectorTest.testInner2 = function() {
	urals_web_BrowserHtmlInjectorTest.setBodyNominal();
	var injector = new urals_web_BrowserHtmlInjector();
	...
	var __sneakerTag = null;
	if(window.document.body.outerHTML == nominal != true) {
		var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("Browser",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("Browser.document",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("Browser.document.body",__sneakerPartialEvaluationResult2),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML",__sneakerPartialEvaluationResult3),new sneaker_assertion_EvaluationResult("nominal",__sneakerPartialEvaluationResult4),new sneaker_assertion_EvaluationResult("Browser.document.body.outerHTML == nominal",__sneakerPartialEvaluationResult5)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserHtmlInjectorTest.hx", lineNumber : 106, className : "urals.web.BrowserHtmlInjectorTest", methodName : "testInner2"});
		throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
	}
};
urals_web_BrowserHtmlInjectorTest.run = function() {
	urals_web_BrowserHtmlInjectorTest.testAppend1();
	urals_web_BrowserHtmlInjectorTest.testAppend2();
	urals_web_BrowserHtmlInjectorTest.testPrepend1();
	urals_web_BrowserHtmlInjectorTest.testPrepend2();
	urals_web_BrowserHtmlInjectorTest.testInner1();
	urals_web_BrowserHtmlInjectorTest.testInner2();
};
var urals_web_BrowserRenderer = function(afterRender) {
	this.afterRender = afterRender;
};
urals_web_BrowserRenderer.__name__ = "urals.web.BrowserRenderer";
...
urals_web_BrowserRenderer.prototype = $extend(urals_web_AbstractRenderer.prototype,{
	...
	,__class__: urals_web_BrowserRenderer
});
var urals_web_BrowserRendererTest = function() { };
urals_web_BrowserRendererTest.__name__ = "urals.web.BrowserRendererTest";
urals_web_BrowserRendererTest.setBodyNominal = function() {
	window.document.body.outerHTML = "<body>" + "<ul></ul>" + "</body>";
};
urals_web_BrowserRendererTest.getElements = function() {
	return [{ id : 1, val : "Click me!"}];
};
urals_web_BrowserRendererTest.rerender = function() {
	var renderId = function(id) {
		return "li_" + (id == null ? "null" : "" + id);
	};
	var rerenderer = new urals_web_BrowserRenderer(function(elHtml,el) {
		elHtml.onclick = function(event) {
			urals_web_BrowserRendererTest.elems.push({ id : urals_web_BrowserRendererTest.elems.length, val : "Click me!"});
			urals_web_BrowserRendererTest.rerender();
		};
	});
	rerenderer.render(urals_web_BrowserRendererTest.elems,function(el) {
		return "ul";
	},{ template : function(m,id) {
		return "<li id=\"" + renderId(id) + "\">" + m + "</li>";
	}, renderId : renderId});
};
urals_web_BrowserRendererTest.run = function() {
	urals_web_BrowserRendererTest.setBodyNominal();
	urals_web_BrowserRendererTest.rerender();
	window.setTimeout(function() {
		window.document.getElementById("li_0").click();
		var __sneakerPartialEvaluationResult0 = urals_web_BrowserRendererTest.elems;
		var __sneakerPartialEvaluationResult1 = __sneakerPartialEvaluationResult0.length;
		var __sneakerPartialEvaluationResult2 = __sneakerPartialEvaluationResult1 == 2;
		var __sneakerTag = null;
		if(urals_web_BrowserRendererTest.elems.length == 2 != true) {
			var __sneakerAssertionResult = sneaker_assertion_AssertionResult.createError(sneaker_assertion_AssertionType.Assertion,[new sneaker_assertion_EvaluationResult("elems",__sneakerPartialEvaluationResult0),new sneaker_assertion_EvaluationResult("elems.length",__sneakerPartialEvaluationResult1),new sneaker_assertion_EvaluationResult("elems.length == 2",__sneakerPartialEvaluationResult2)],__sneakerTag,null,{ fileName : "test/urals/web/BrowserRendererTest.hx", lineNumber : 46, className : "urals.web.BrowserRendererTest", methodName : "run"});
			throw haxe_Exception.thrown(new sneaker_assertion_AssertionException(__sneakerAssertionResult));
		}
	},50);
};
...
urals_web_BrowserRendererTest.elems = [{ id : 0, val : "Click me!"}];
Main.main();
